...
from submodules.Relightable3DGaussian.vismvsnet.utils.preproc import to_channel_first, \
    resize, random_crop, recursive_apply, image_net_center_inv, scale_camera
from submodules.Relightable3DGaussian.vismvsnet.utils.io_utils import load_model, \
    subplot_map, write_cam, write_pfm
...
if __name__ == '__main__':
    ...
    num_src = len([i for i in os.listdir(os.path.join(args.data_root, 'images')) if os.path.splitext(i)[-1] == '.jpg'])

    dataset, loader = get_val_loader(
        args.data_root, num_src,
        {
    ...
    for i, sample in pbar:
        ...
        if (i % 49 == 0 or True) and (args.show_result or args.write_result):
            ...
            if args.write_result:
                ...
                save_image(os.path.join(args.result_dir, f'{sample_name}.jpg'), ref_o)
