...
#
    ...
    os.system(f'ln -s {image_dir} {save_dir}/')
    os.system(f'ln -s {args.dense_folder}/sparse {save_dir}/')
    cam_dir = os.path.join(save_dir, 'cams')
    # renamed_dir = os.path.join(save_dir, 'images')
    ...
    with open(os.path.join(save_dir, 'pair.txt'), 'w') as f:
        f.write('%d\n' % len(images))
